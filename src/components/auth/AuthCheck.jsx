// components/auth/AuthCheck.jsx - To'liq qayta yozilgan
    ...
    switch (authStatus) {
      case 'checking':
        return {
          ...
          icon: (
            <svg className="auth-spinner" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          message: 'Iltimos, biroz kuting. Sizning ma\'lumotlaringiz tekshirilmoqda.',
          buttonText: 'Kuting...',
          buttonDisabled: true,
          showProgress: true
        };
      ...
      case 'not_registered':
        return {
          ...
          message: 'Siz hali ro\'yxatdan o\'tmagansiz. Iltimos, avval @yuldagilar_bot da /start buyrug\'ini bosib ro\'yxatdan o\'ting.',
      ...
      case 'not_approved':
        return {
          ...
          message: 'Siz ro\'yxatdan o\'tgansiz, lekin admin tomonidan hali tasdiqlanmagan. Iltimos, kuting yoki adminga murojaat qiling.',
      ...
      case 'error':
        return {
          ...
          message: error || 'Tizimda xatolik yuz berdi. Iltimos, qayta urinib ko\'ring.',
      ...
      <div className={`auth-content ${isAnimating ? 'auth-visible' : ''}`}>
        ...
        <div className="auth-header">
          ...
          <div className="auth-header-content">
            ...
            <p className="auth-header-subtitle">Yo'lga chiq - Yo'ldan chiqma!</p>
          </div>
        </div>
        ...
        <div className="auth-main-card">
          ...
          >
            {config.buttonIcon && <span className="auth-button-icon">{config.buttonIcon}</span>}
          ...
          {config.showHelp && (
            <div className="auth-help">
              <p className="auth-help-text">
                Muammo bo'lsa, admin bilan bog'laning: <span className="auth-admin-link">@muhammadsaid_buxoriy</span>
              </p>
            </div>
          )}
        </div>
        ...
        <div className="auth-footer">
          <p className="auth-footer-text">© 2025 Yo'ldagilar Challenge Platform</p>
        </div>
      </div>
    </div>
  );
